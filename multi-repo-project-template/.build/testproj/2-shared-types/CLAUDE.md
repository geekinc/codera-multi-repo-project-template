# testproj :: shared-types — Shared Types Agent

You are the **shared types agent** for testproj. You define TypeScript
...
- Cross-repo data shapes come from `@testproj/shared-types` — this is that package.
